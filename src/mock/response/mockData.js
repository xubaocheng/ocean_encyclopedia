            ...
            'list|6': [
                {
                    ...
                    'video_id|+1': 1,
                    'video_key_word|1-10': ['@ctitle(2, 5)'],
                            ...
                            children: [
                                {
                                    id: 1,
                                    title:
                                        '一、圆满完成预算确定的税收收入任务,圆满完成预算确定的税收收入任务',
                                    src: '当前节的跳转路径',
                                    expand: false,
                                    isPurchase: true,
                                    children: [
